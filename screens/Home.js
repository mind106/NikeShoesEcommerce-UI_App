...
const Home = ({ navigation }) => {
    ...
    function renderTrendingShoes(item, index) {
        ...
        return (
            ...
            >
                ...
                <View style={{ position: 'absolute', top: 24, right: 0, width: "95%", height: "100%" }}>
    ...
    return (
        <View style={styles.container}>
            <Text style={{ marginTop: SIZES.radius, marginHorizontal: SIZES.padding, }}>TRENDING</Text>
                ...
                >
                    ...
                    >
                        ...
                        <View style={{ justifyContent: 'center', width: "85%", backgroundColor: selectedItem.bgColor }}>
                            ...
                            <Text style={{ marginTop: SIZES.padding, marginHorizontal: SIZES.padding, color: COLORS.white,  }}>{selectedItem.name}</Text>
                            <Text style={{ marginTop: SIZES.base / 2, marginHorizontal: SIZES.padding, color: COLORS.white,  }}>{selectedItem.type}</Text>
                            <Text style={{ marginTop: SIZES.radius, marginHorizontal: SIZES.padding, color: COLORS.white, }}>{selectedItem.price}</Text>
                            <View style={{ flexDirection: 'row', marginTop: SIZES.radius, marginHorizontal: SIZES.padding }}>
                                <View>
                                    <Text style={{ color: COLORS.white, }}>Select size</Text>
                                </View>
